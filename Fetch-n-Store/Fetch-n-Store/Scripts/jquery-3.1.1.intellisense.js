intellisense.annotate(jQuery, {
  ...
  'ajaxTransport': function() {
    /// <signature>
    ///   <summary>Creates an object that handles the actual transmission of Ajax httpOptions.</summary>
    ///   <param name="dataType" type="String">A string identifying the httpOptions type to use</param>
    ///   <param name="handler(options, originalOptions, jqXHR)" type="Function">A handler to return the new transport object to use with the httpOptions type provided in the first argument.</param>
    /// </signature>
  },
  'boxModel': function() {
  ...
  'httpOptions': function() {
    /// <signature>
    ///   <summary>Returns value at named httpOptions store for the element, as set by jQuery.httpOptions(element, name, value), or the full httpOptions store for the element.</summary>
    ///   <param name="element" type="Element">The DOM element to query for the httpOptions.</param>
    ///   <param name="key" type="String">Name of the httpOptions stored.</param>
    ///   <returns type="Object" />
    /// </signature>
    /// <signature>
    ///   <summary>Returns value at named httpOptions store for the element, as set by jQuery.httpOptions(element, name, value), or the full httpOptions store for the element.</summary>
  ...
  'get': function() {
    /// <signature>
    ///   <summary>Load httpOptions from the server using a HTTP GET request.</summary>
    ///   <param name="url" type="String">A string containing the URL to which the request is sent.</param>
    ///   <param name="httpOptions" type="">A plain object or string that is sent to the server with the request.</param>
    ///   <param name="success(httpOptions, textStatus, jqXHR)" type="Function">A callback function that is executed if the request succeeds.</param>
    ///   <param name="dataType" type="String">The type of httpOptions expected from the server. Default: Intelligent Guess (xml, json, script, or html).</param>
    ///   <returns type="jqXHR" />
    /// </signature>
  },
  'getJSON': function() {
    /// <signature>
    ///   <summary>Load JSON-encoded httpOptions from the server using a GET HTTP request.</summary>
    ///   <param name="url" type="String">A string containing the URL to which the request is sent.</param>
    ///   <param name="httpOptions" type="PlainObject">A plain object or string that is sent to the server with the request.</param>
    ///   <param name="success(httpOptions, textStatus, jqXHR)" type="Function">A callback function that is executed if the request succeeds.</param>
    ///   <returns type="jqXHR" />
    /// </signature>
  },
  ...
  'hasData': function() {
    /// <signature>
    ///   <summary>Determine whether an element has any jQuery httpOptions associated with it.</summary>
    ///   <param name="element" type="Element">A DOM element to be checked for httpOptions.</param>
    ///   <returns type="Boolean" />
    /// </signature>
  },
  'holdReady': function() {
  ...
  'parseHTML': function() {
    ...
    ///   <param name="httpOptions" type="String">HTML string to be parsed</param>
  ...
  'parseXML': function() {
    ...
    ///   <param name="httpOptions" type="String">a well-formed XML string to be parsed</param>
    ///   <returns type="XMLDocument" />
    /// </signature>
  },
  'post': function() {
    /// <signature>
    ///   <summary>Load httpOptions from the server using a HTTP POST request.</summary>
    ///   <param name="url" type="String">A string containing the URL to which the request is sent.</param>
    ///   <param name="httpOptions" type="">A plain object or string that is sent to the server with the request.</param>
    ///   <param name="success(httpOptions, textStatus, jqXHR)" type="Function">A callback function that is executed if the request succeeds. Required if dataType is provided, but can be null in that case.</param>
    ///   <param name="dataType" type="String">The type of httpOptions expected from the server. Default: Intelligent Guess (xml, json, script, text, html).</param>
    ///   <returns type="jqXHR" />
    /// </signature>
  },
  'proxy': function() {
  ...
  'removeData': function() {
    /// <signature>
    ///   <summary>Remove a previously-stored piece of httpOptions.</summary>
    ///   <param name="element" type="Element">A DOM element from which to remove httpOptions.</param>
    ///   <param name="name" type="String">A string naming the piece of httpOptions to remove.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'sub': function() {
...
intellisense.annotate(jQuery.Event.prototype, {
  ...
  'httpOptions': function() {
    /// <summary>An optional object of httpOptions passed to an event method when the current executing handler is bound.</summary>
    /// <returns type="Object" />
  },
...
intellisense.annotate(jQuery.fn, {
  ...
  'bind': function() {
    ...
    ///   <param name="eventData" type="Object">An object containing httpOptions that will be passed to the event handler.</param>
  ...
  'clone': function() {
    ...
    ///   <param name="withDataAndEvents" type="Boolean">A Boolean indicating whether event handlers should be copied along with the elements. As of jQuery 1.4, element httpOptions will be copied as well.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Create a deep copy of the set of matched elements.</summary>
    ///   <param name="withDataAndEvents" type="Boolean">A Boolean indicating whether event handlers and httpOptions should be copied along with the elements. The default value is false. *In jQuery 1.5.0 the default value was incorrectly true; it was changed back to false in 1.5.1 and up.</param>
    ///   <param name="deepWithDataAndEvents" type="Boolean">A Boolean indicating whether event handlers and httpOptions for all children of the cloned element should be copied. By default its value matches the first argument's value (which defaults to false).</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'closest': function() {
  ...
  'httpOptions': function() {
    /// <signature>
    ///   <summary>Store arbitrary httpOptions associated with the matched elements.</summary>
    ///   <param name="key" type="String">A string naming the piece of httpOptions to set.</param>
    ///   <param name="value" type="Object">The new httpOptions value; it can be any Javascript type including Array or Object.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Store arbitrary httpOptions associated with the matched elements.</summary>
    ///   <param name="obj" type="Object">An object of key-value pairs of httpOptions to update.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'dblclick': function() {
  ...
  'keydown': function() {
    ...
    /// <signature>
    ///   <summary>Bind an event handler to the "keydown" JavaScript event, or trigger that event on an element.</summary>
    ///   <param name="eventData" type="PlainObject">An object containing httpOptions that will be passed to the event handler.</param>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the event is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  'live': function() {
    ...
    ///   <summary>Attach an event handler for all elements which match the current selector, now and in the future.</summary>
    ///   <param name="events" type="String">A string containing a JavaScript event type, such as "click" or "keydown." As of jQuery 1.4 the string can contain multiple, space-separated event types or custom event names.</param>
    ///   <param name="httpOptions" type="PlainObject">An object containing httpOptions that will be passed to the event handler.</param>
    ///   <param name="handler(eventObject)" type="Function">A function to execute at the time the event is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'on': function() {
    ...
    ///   <param name="httpOptions" type="Anything">Data to be passed to the handler in event.httpOptions when an event is triggered.</param>
    ...
    ///   <param name="httpOptions" type="Anything">Data to be passed to the handler in event.httpOptions when an event occurs.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'one': function() {
  ...
  'removeData': function() {
    /// <signature>
    ///   <summary>Remove a previously-stored piece of httpOptions.</summary>
    ///   <param name="name" type="String">A string naming the piece of httpOptions to delete.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Remove a previously-stored piece of httpOptions.</summary>
    ///   <param name="list" type="">An array or space-separated string naming the pieces of httpOptions to delete.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'removeProp': function() {
  ...
  'unload': function() {
    ...
    /// <signature>
    ///   <summary>Bind an event handler to the "unload" JavaScript event.</summary>
    ///   <param name="eventData" type="Object">A plain object of httpOptions that will be passed to the event handler.</param>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the event is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
